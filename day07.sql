...
add zipcode varchar(30), add adres varchar(30) --burada bos kutular olusturur
...
ALTER TABLE personel
DROP COLUMN zipcode --bu sutunu siler
...
/*
Transaction başlatmak için BEGIN komutu kullanmamız gerekir ve Transaction'ı sonlandirmak için
