...
select isim from ogrenciler4 where sinav_notu='85' and adres='Ankara';
...
--kisayolu
select * from ogrenciler4 where sinav_notu in (65, 85);
...
select isim, sinav_notu from ogrenciler4 where id not between 122 and 125;
