...
-- UPPER – LOWER - INITCAP
-- Kelimeler tablosundaki kelime sutunundaki verileri önce hepsi büyük harf, sonra küçük harf ve ilk harfleri büyük harf olucak şekilde yazdıralım
SELECT UPPER(kelime) as büyükharf FROM kelimeler
SELECT LOWER(kelime) as kucukharf FROM kelimeler
